...
export default function Header() {
  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 h-20 w-full border-b bg-white/85 backdrop-blur transition-all duration-300 ${
      ...
      <div className="mx-auto flex h-full max-w-6xl items-center justify-between px-6 md:px-10">
        ...
        <nav className="hidden items-center gap-8 md:flex" aria-label="Primary">
          ...
          <a
            ...
            className="cursor-pointer rounded-full bg-navy px-5 py-2.5 text-sm font-medium text-white transition-colors duration-200 hover:bg-navy/85"
          >
        ...
        <div className="border-b border-line bg-white md:hidden">
          ...
          >
            ...
            <a
              href="#contact"
              onClick={handleCtaClick}
              className="cursor-pointer block rounded-full bg-navy px-5 py-2.5 text-center text-sm font-medium text-white transition-colors duration-200 hover:bg-navy/85"
            >
              Request a Consultation
            </a>
          </nav>
